# nvim-treesitter-queries-authzed

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-authzed/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-authzed/actions/workflows/validate.yml)

Neovim tree-sitter queries for **authzed**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-authzed",
...
- [ ] Changes are scoped to `authzed` — do not include files for other languages
